...
function onUpdate()
	...
	doTweenAlpha('AlphaTween1', 'winningIcon', 0, 0.25)
    doTweenAlpha('AlphaTween2', 'healthBar', 0, 0.25)
	doTweenAlpha('AlphaTween3', 'scoreTxtLua', 0, 0.25)
	...
	doTweenAlpha('AlphaTween9', 'winningIconDad', 0, 0.25)
	doTweenAlpha('AlphaTween10', 'cuphealthbar', 0, 0.25)
	doTweenAlpha('AlphaTween11', 'healthbar_p1', 0, 0.25)
	doTweenAlpha('AlphaTween12', 'healthbar_p2', 0, 0.25)
	doTweenAlpha('AlphaTween13', 'healt', 0, 0.25)
	doTweenAlpha('AlphaTween14', 'timer', 0, 0.25)
	doTweenAlpha('AlphaTween15', 'timer2', 0, 0.25)
	doTweenAlpha('AlphaTween16', 'timerIcon', 0, 0.25)
	end
	...
	doTweenAlpha('AlphaTween1', 'winningIcon', 1, 0.25)
	doTweenAlpha('AlphaTween2', 'healthBar', 1, 0.25)
	doTweenAlpha('AlphaTween3', 'scoreTxtLua', 1, 0.25)
	...
	doTweenAlpha('AlphaTween9', 'winningIconDad', 1, 0.25)
	doTweenAlpha('AlphaTween10', 'cuphealthbar', 1, 0.25)
	doTweenAlpha('AlphaTween11', 'healthbar_p1', 1, 0.25)
	doTweenAlpha('AlphaTween12', 'healthbar_p2', 1, 0.25)
	doTweenAlpha('AlphaTween13', 'healt', 1, 0.25)
	doTweenAlpha('AlphaTween14', 'timer', 1, 0.25)
	doTweenAlpha('AlphaTween15', 'timer2', 1, 0.25)
	doTweenAlpha('AlphaTween16', 'timerIcon', 1, 0.25)
